...
public class JansiWinSysTerminal extends AbstractWindowsTerminal {
    ...
    public static JansiWinSysTerminal createTerminal(String name, String type, boolean ansiPassThrough, Charset encoding,
                                                     int codepage, boolean nativeSignals, SignalHandler signalHandler, boolean paused, InputThread inputHandler) throws IOException {
        Writer writer;
        int[] mode = new int[1];
        if (ansiPassThrough) {
            if (type == null) {
        ...
        JansiWinSysTerminal terminal = new JansiWinSysTerminal(writer, name, type, encoding, codepage, nativeSignals, signalHandler, inputHandler);
    ...
    JansiWinSysTerminal(Writer writer, String name, String type, Charset encoding, int codepage, boolean nativeSignals, SignalHandler signalHandler, InputThread inputHandler) throws IOException {
        super(writer, name, type, encoding, codepage, nativeSignals, signalHandler, inputHandler);
    }
